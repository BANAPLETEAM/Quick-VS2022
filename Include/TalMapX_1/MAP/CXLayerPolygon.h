...
// CXLayerPolygon 래퍼 클래스

class CXLayerPolygon : public COleDispatchDriver
{
public:
	CXLayerPolygon(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerPolygon(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerPolygon(const CXLayerPolygon& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long SetShowDistance(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value);
		return result;
	}
	...
	BOOL SetAdminShape(LPDISPATCH Item, long Type)
	{
		BOOL result;
		static BYTE parms[] = VTS_DISPATCH VTS_I4 ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Item, Type);
		return result;
	}
