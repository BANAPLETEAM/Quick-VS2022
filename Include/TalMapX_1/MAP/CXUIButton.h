...
class CXUIButton : public COleDispatchDriver
{
public:
	CXUIButton(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIButton(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIButton(const CXUIButton& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long SetImageAutoChange(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x138a, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value);
		return result;
	}
	long GetImageAutoChange()
	{
		long result;
		InvokeHelper(0x138b, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	void SetAnimationImage(LPDISPATCH Image)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x138c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Image);
	}
	void SetAnimationInterval(long Interval, long Count)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x138d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Interval, Count);
	}
