...
class CXUIMapPanel : public COleDispatchDriver
{
public:
	CXUIMapPanel(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIMapPanel(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIMapPanel(const CXUIMapPanel& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL SetPanelImage(LPCTSTR LeftPath, LPCTSTR BodyPath, LPCTSTR RightPath)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x1771, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, LeftPath, BodyPath, RightPath);
		return result;
	}
	BOOL SetImageFromImageMan(LPCTSTR TopName, LPCTSTR BodyName, LPCTSTR BottomName)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, TopName, BodyName, BottomName);
		return result;
	}
	void SetStretch(long Value)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1774, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	long GetStretch()
	{
		long result;
		InvokeHelper(0x1775, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	void SetMapPos(long Lon, long Lat)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x1389, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Lon, Lat);
	}
	LPDISPATCH GetMapPos()
	{
		LPDISPATCH result;
		InvokeHelper(0x138a, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	void SetMapOwner(LPDISPATCH Owner)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x138b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Owner);
	}
	LPDISPATCH GetMapOwner()
	{
		LPDISPATCH result;
		InvokeHelper(0x138c, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	long SetMapSync(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x138d, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value);
		return result;
	}
	long GetMapSync()
	{
		long result;
		InvokeHelper(0x138e, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
