...
// CXLayerTraffic 래퍼 클래스

class CXLayerTraffic : public COleDispatchDriver
{
public:
	CXLayerTraffic(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerTraffic(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerTraffic(const CXLayerTraffic& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH Link_New(long LinkID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1389, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LinkID);
		return result;
	}
	LPDISPATCH Link_Find(long LinkID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x138a, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LinkID);
		return result;
	}
	void Link_Clear()
	{
		InvokeHelper(0x138b, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void Link_Delete(long LinkID)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x138c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, LinkID);
	}
	long Link_GetCount()
	{
		long result;
		InvokeHelper(0x138d, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
