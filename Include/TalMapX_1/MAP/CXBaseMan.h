...
class CXBaseMan : public COleDispatchDriver
{
public:
	CXBaseMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXBaseMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXBaseMan(const CXBaseMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
