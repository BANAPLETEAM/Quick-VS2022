...
class CXObjectBase : public COleDispatchDriver
{
public:
	CXObjectBase(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXObjectBase(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXObjectBase(const CXObjectBase& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
