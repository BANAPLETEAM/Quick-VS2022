...
// CXApplication 래퍼 클래스

class CXApplication : public COleDispatchDriver
{
public:
	CXApplication(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXApplication(const CXApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
