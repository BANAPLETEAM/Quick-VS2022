...
// CXMapChartBar 래퍼 클래스

class CXMapChartBar : public COleDispatchDriver
{
public:
	CXMapChartBar(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXMapChartBar(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXMapChartBar(const CXMapChartBar& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void SetMaxValue(double Value)
	{
		...
		InvokeHelper(0x1771, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	double GetMaxValue()
	{
		double result;
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_R8, (void*)&result, NULL);
		return result;
	}
	void SetHeight(long Value)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1773, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	long GetHeight()
	{
		long result;
		InvokeHelper(0x1774, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long AddData(double Value, long Width, long Space, long BColor, long FColor, float LineWidth)
	{
		long result;
		static BYTE parms[] = VTS_R8 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_R4 ;
		InvokeHelper(0x1775, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value, Width, Space, BColor, FColor, LineWidth);
		return result;
	}
	void SetMinValue(double Value)
	{
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0x1776, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	double GetMinValue()
	{
		double result;
		InvokeHelper(0x1777, DISPATCH_METHOD, VT_R8, (void*)&result, NULL);
		return result;
	}
