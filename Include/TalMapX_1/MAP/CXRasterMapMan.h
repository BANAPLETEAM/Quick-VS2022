...
// CXRasterMapMan 래퍼 클래스

class CXRasterMapMan : public COleDispatchDriver
{
public:
	CXRasterMapMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXRasterMapMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXRasterMapMan(const CXRasterMapMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
