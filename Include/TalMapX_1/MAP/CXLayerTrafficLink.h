...
// CXLayerTrafficLink 래퍼 클래스

class CXLayerTrafficLink : public COleDispatchDriver
{
public:
	CXLayerTrafficLink(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerTrafficLink(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerTrafficLink(const CXLayerTrafficLink& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x1771, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	long SetValue_LayerTrafficLink(long Type, long Code, LPDISPATCH Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_DISPATCH ;
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Type, Code, Value);
		return result;
	}
	long GetValue_LayerTrafficLink(long Type, long Code, LPDISPATCH Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_DISPATCH ;
		InvokeHelper(0x1773, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Type, Code, Value);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x1777, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}

	// IXLayerTrafficLink 속성
public:
