...
// CXLayerCustomList 래퍼 클래스

class CXLayerCustomList : public COleDispatchDriver
{
public:
	CXLayerCustomList(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerCustomList(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerCustomList(const CXLayerCustomList& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
