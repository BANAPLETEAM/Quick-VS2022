...
class CXUIObj : public COleDispatchDriver
{
public:
	CXUIObj(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIObj(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIObj(const CXUIObj& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
