...
// CXMapChartPie 래퍼 클래스

class CXMapChartPie : public COleDispatchDriver
{
public:
	CXMapChartPie(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXMapChartPie(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXMapChartPie(const CXMapChartPie& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void SetRadius(double RadiusX, double RadiusY)
	{
		...
		InvokeHelper(0x1771, DISPATCH_METHOD, VT_EMPTY, NULL, parms, RadiusX, RadiusY);
	}
	long AddData(double Value, long BColor, long FColor, float LineWidth)
	{
		long result;
		static BYTE parms[] = VTS_R8 VTS_I4 VTS_I4 VTS_R4 ;
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value, BColor, FColor, LineWidth);
		return result;
	}
