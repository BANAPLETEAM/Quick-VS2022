...
class CXUIBaseMan : public COleDispatchDriver
{
public:
	CXUIBaseMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIBaseMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIBaseMan(const CXUIBaseMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
