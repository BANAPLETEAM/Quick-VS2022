...
// CXUIAlertCircle 래퍼 클래스

class CXUIAlertCircle : public COleDispatchDriver
{
public:
	CXUIAlertCircle(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIAlertCircle(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIAlertCircle(const CXUIAlertCircle& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void SetPen(unsigned long Color, float Width, long Style)
	{
		static BYTE parms[] = VTS_UI4 VTS_R4 VTS_I4 ;
		InvokeHelper(0x1b59, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Color, Width, Style);
	}
	void SetBrush(unsigned long Color)
	{
		static BYTE parms[] = VTS_UI4 ;
		InvokeHelper(0x1b5a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Color);
	}
	void SetMapPos(LPDISPATCH Pos)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x1b5b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Pos);
	}
	void SetAnimation(long MaxSize, long MinSize, long Interval, long Step, long Continue, long Type)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x1771, DISPATCH_METHOD, VT_EMPTY, NULL, parms, MaxSize, MinSize, Interval, Step, Continue, Type);
	}
