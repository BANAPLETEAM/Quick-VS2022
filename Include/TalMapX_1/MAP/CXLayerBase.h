...
class CXLayerBase : public COleDispatchDriver
{
public:
	CXLayerBase(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerBase(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerBase(const CXLayerBase& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
