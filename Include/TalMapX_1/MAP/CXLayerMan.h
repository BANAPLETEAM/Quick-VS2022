...
class CXLayerMan : public COleDispatchDriver
{
public:
	CXLayerMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerMan(const CXLayerMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
