...
class CXUIImage : public COleDispatchDriver
{
public:
	CXUIImage(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIImage(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIImage(const CXUIImage& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	long GetStretch()
	{
		long result;
		InvokeHelper(0x1773, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	void SetMGImage(LPDISPATCH Image)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x1774, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Image);
	}
	LPDISPATCH GetMGImage()
	{
		LPDISPATCH result;
