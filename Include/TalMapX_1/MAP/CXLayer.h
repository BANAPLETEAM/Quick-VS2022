...
class CXLayer : public COleDispatchDriver
{
public:
	CXLayer(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayer(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayer(const CXLayer& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void ClearObject()
	{
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	LPDISPATCH FindObject(long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1773, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LayerObjectID);
		return result;
	}
	LPDISPATCH NewObject(long ObjectID, long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x1774, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ObjectID, LayerObjectID);
		return result;
	}
	BOOL DeleteObject(long LayerObjectID)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1775, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, LayerObjectID);
		return result;
	}
	LPDISPATCH NewShape(long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1776, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LayerObjectID);
		return result;
	}
	LPDISPATCH NewPolygon(long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1777, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LayerObjectID);
		return result;
	}
	LPDISPATCH NewCircle(long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1778, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LayerObjectID);
		return result;
	}
	LPDISPATCH NewDensity(long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1779, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LayerObjectID);
		return result;
	}
	LPDISPATCH NewTraffic(long LayerObjectID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x177a, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, LayerObjectID);
		return result;
	}
	void SetDrawLevel(long Type)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x177b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Type);
	}
	long GetDrawLevel()
	{
		long result;
		InvokeHelper(0x177c, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long GetObjectCount()
	{
	...
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x177e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Index);
	}
	long GetIndex()
	{
		long result;
		InvokeHelper(0x177f, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH GetObject(long Index)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1780, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Index);
		return result;
	}
