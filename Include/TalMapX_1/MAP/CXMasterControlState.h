...
// CXMasterControlState 래퍼 클래스

class CXMasterControlState : public COleDispatchDriver
{
public:
	CXMasterControlState(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXMasterControlState(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXMasterControlState(const CXMasterControlState& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL CheckValidClickPoint(long X, long Y)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x1, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, X, Y);
		return result;
	}
	BOOL HistorySave(LPCTSTR Name)
	{
		BOOL result;
	...
	BOOL HistoryRestore(LPCTSTR Name)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR ;
	...
	void HistoryAutoSave(LPCTSTR Name)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Name);
	}
	void HistoryDeleteSave(LPCTSTR Name)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Name);
	}
	BOOL HistoryPrev()
	{
		BOOL result;
	...
	void SetHint(LPCTSTR Caption, LPCTSTR Contents)
	{
		...
		InvokeHelper(0xa, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Caption, Contents);
	}

	// IXMasterControlState 속성
public:
