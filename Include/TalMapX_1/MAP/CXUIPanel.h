...
class CXUIPanel : public COleDispatchDriver
{
public:
	CXUIPanel(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIPanel(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIPanel(const CXUIPanel& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
