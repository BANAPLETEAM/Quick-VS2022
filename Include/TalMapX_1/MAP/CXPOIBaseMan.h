...
class CXPOIBaseMan : public COleDispatchDriver
{
public:
	CXPOIBaseMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXPOIBaseMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXPOIBaseMan(const CXPOIBaseMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
