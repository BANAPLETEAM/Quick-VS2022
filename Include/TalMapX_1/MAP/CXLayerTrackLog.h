...
// CXLayerTrackLog 래퍼 클래스

class CXLayerTrackLog : public COleDispatchDriver
{
public:
	CXLayerTrackLog(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerTrackLog(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerTrackLog(const CXLayerTrackLog& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL LoadData(LPCTSTR Path, long DataType, long RecType)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_I4 VTS_I4 ;
		InvokeHelper(0x1, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Path, DataType, RecType);
		return result;
	}
	BOOL LoadPosImageBMP(LPCTSTR Name, LPCTSTR Path, long ItemWidth, long ItemHeight)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_I4 VTS_I4 ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Name, Path, ItemWidth, ItemHeight);
		return result;
	}
	BOOL Run(long Type, long Interval, long Loop)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x3, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Type, Interval, Loop);
		return result;
	}
	long Item_Count()
	{
	...
	BOOL Item_Select(long ItemIndex)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, ItemIndex);
		return result;
	}
	long Item_Angle()
	{
	...
	CString Item_TimeStr(long Type)
	{
		CString result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xa, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, Type);
		return result;
	}
