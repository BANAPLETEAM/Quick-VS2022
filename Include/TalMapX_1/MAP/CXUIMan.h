...
class CXUIMan : public COleDispatchDriver
{
public:
	CXUIMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIMan(const CXUIMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long SetDrawObjectRect(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1771, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value);
		return result;
	}
	long GetDrawObjectRect()
	{
		long result;
		InvokeHelper(0x1772, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	void ClearAlert()
	{
		InvokeHelper(0x1773, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void DeleteAlert(long ID)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1774, DISPATCH_METHOD, VT_EMPTY, NULL, parms, ID);
	}
	LPDISPATCH NewAlertCircle(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1775, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
	void SetInfo(long Type, long Value)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x1776, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Type, Value);
	}
	long GetInfo(long Type)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1777, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Type);
		return result;
	}
	LPDISPATCH CreateUI_Panel(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17d5, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_Button(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17d6, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_Image(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17d7, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_ImageList(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17d8, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_StaticText(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17d9, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_ImageText(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17da, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_CheckBox(LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x17db, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Owner);
		return result;
	}
	LPDISPATCH CreateUI_MapPanel(LPDISPATCH CtrlMan, LPDISPATCH Owner)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH VTS_DISPATCH ;
		InvokeHelper(0x17dc, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, CtrlMan, Owner);
		return result;
	}
	LPDISPATCH CastToBaseManager()
	{
		LPDISPATCH result;
	...
	long SetShowCenterCursor(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
	...
	long GetShowCenterCursor()
	{
		long result;
		InvokeHelper(0x6, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long SetShowCenterLine(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
	...
	long GetShowCenterLine()
	{
		long result;
		InvokeHelper(0x8, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long SetShowCenterRadius(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
	...
	long GetShowCenterRadius()
	{
		long result;
		InvokeHelper(0xa, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long SetShowLevelBar(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
	...
	long GetShowLevelBar()
	{
		long result;
		InvokeHelper(0xc, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long SetShowCompass(long Value)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xd, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value);
		return result;
	}
	long GetShowCompass()
	{
	...
	BOOL SetCompassImage(LPCTSTR Path, long Width, long Height)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_I4 VTS_I4 ;
		InvokeHelper(0xf, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Path, Width, Height);
		return result;
	}
	LPDISPATCH GetLevelBar()
	{
		LPDISPATCH result;
		InvokeHelper(0x10, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH GetCompass()
	{
		LPDISPATCH result;
		InvokeHelper(0x11, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	void SetMessage(LPCTSTR Msg, long Time)
	{
		static BYTE parms[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x12, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Msg, Time);
	}
	LPDISPATCH GetMessageBox()
	{
		LPDISPATCH result;
