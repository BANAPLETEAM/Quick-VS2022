...
class CXAdminMan : public COleDispatchDriver
{
public:
	CXAdminMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXAdminMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXAdminMan(const CXAdminMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL LoadAdmin(LPCTSTR Path)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x1, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Path);
		return result;
	}
	LPDISPATCH GetAdminItem(long Lon, long Lat)
	{
		LPDISPATCH result;
	...
	LPDISPATCH GetAdminItemByCode(LPCTSTR AdminCode)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x3, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, AdminCode);
		return result;
	}
	void DestroyAdminItem(LPDISPATCH Item)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Item);
	}
	CString GetAdminInfoList(LPCTSTR AdminCode, long Type)
	{
		CString result;
		static BYTE parms[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, AdminCode, Type);
		return result;
	}
