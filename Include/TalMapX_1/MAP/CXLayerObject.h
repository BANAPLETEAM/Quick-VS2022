...
// CXLayerObject 래퍼 클래스

class CXLayerObject : public COleDispatchDriver
{
public:
	CXLayerObject(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerObject(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerObject(const CXLayerObject& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
