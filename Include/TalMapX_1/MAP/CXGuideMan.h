...
class CXGuideMan : public COleDispatchDriver
{
public:
	CXGuideMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXGuideMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXGuideMan(const CXGuideMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long SetWidth(long newVal)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1, DISPATCH_METHOD, VT_I4, (void*)&result, parms, newVal);
		return result;
	}
	long GetWidth()
	{
	...
	long SetHeight(long newVal)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3, DISPATCH_METHOD, VT_I4, (void*)&result, parms, newVal);
		return result;
	}
	long GetHeight()
	{
