...
// CXObjectState 래퍼 클래스

class CXObjectState : public COleDispatchDriver
{
public:
	CXObjectState(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXObjectState(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXObjectState(const CXObjectState& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
