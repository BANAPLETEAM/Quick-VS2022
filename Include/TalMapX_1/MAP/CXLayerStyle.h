...
class CXLayerStyle : public COleDispatchDriver
{
public:
	CXLayerStyle(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerStyle(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerStyle(const CXLayerStyle& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void SetPen(long Color, double Width, long Style)
	{
		static BYTE parms[] = VTS_I4 VTS_R8 VTS_I4 ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Color, Width, Style);
	}
	...
	void SetBrush(long Color, long Style)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Color, Style);
	}
