...
// CXUIImageText 래퍼 클래스

class CXUIImageText : public COleDispatchDriver
{
public:
	CXUIImageText(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIImageText(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIImageText(const CXUIImageText& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
