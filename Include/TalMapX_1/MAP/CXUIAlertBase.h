...
// CXUIAlertBase 래퍼 클래스

class CXUIAlertBase : public COleDispatchDriver
{
public:
	CXUIAlertBase(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIAlertBase(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIAlertBase(const CXUIAlertBase& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
