...
// CXUIStaticText 래퍼 클래스

class CXUIStaticText : public COleDispatchDriver
{
public:
	CXUIStaticText(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIStaticText(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIStaticText(const CXUIStaticText& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
