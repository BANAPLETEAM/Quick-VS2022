...
class CXRouteMan0 : public COleDispatchDriver
{
public:
	CXRouteMan0(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXRouteMan0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXRouteMan0(const CXRouteMan0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH NewRoute(long Type, long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x1773, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Type, ID);
		return result;
	}
	LPDISPATCH FindRoute(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x1774, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
	LPDISPATCH GetCurrentRoute()
	{
		LPDISPATCH result;
		InvokeHelper(0x1775, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	void SetCurrentRoute(LPDISPATCH Route)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x1776, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Route);
	}
