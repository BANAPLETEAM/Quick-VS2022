...
class CXLayerShape : public COleDispatchDriver
{
public:
	CXLayerShape(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXLayerShape(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXLayerShape(const CXLayerShape& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long AddPoint(long X, long Y)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_I4, (void*)&result, parms, X, Y);
		return result;
	}
	long GetPointCount()
	{
	...
	void SetMapPos(long Lon, long Lat, long Altitude)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Lon, Lat, Altitude);
	}
	void SetAngle(long X, long Y, long Z)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_EMPTY, NULL, parms, X, Y, Z);
	}
