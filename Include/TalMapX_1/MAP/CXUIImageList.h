...
// CXUIImageList 래퍼 클래스

class CXUIImageList : public COleDispatchDriver
{
public:
	CXUIImageList(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXUIImageList(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXUIImageList(const CXUIImageList& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
