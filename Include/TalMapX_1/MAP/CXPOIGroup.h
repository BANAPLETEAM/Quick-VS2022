...
class CXPOIGroup : public COleDispatchDriver
{
public:
	CXPOIGroup(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXPOIGroup(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXPOIGroup(const CXPOIGroup& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH NewItem(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
	LPDISPATCH FindItem(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
