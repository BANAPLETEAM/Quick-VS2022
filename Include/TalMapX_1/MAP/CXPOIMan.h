...
class CXPOIMan : public COleDispatchDriver
{
public:
	CXPOIMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXPOIMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXPOIMan(const CXPOIMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH NewGroup(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3e9, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
	LPDISPATCH FindGroup(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
	...
	long DeleteGroup(long ID)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3eb, DISPATCH_METHOD, VT_I4, (void*)&result, parms, ID);
		return result;
	}
	void ClearGroup()
	{
	...
	{
		long result;
		InvokeHelper(0x3ed, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	void ClearStyle()
	{
	...
	LPDISPATCH FindStyle(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3ef, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
	LPDISPATCH NewStyle(long ID)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3f0, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, ID);
		return result;
	}
	void DeleteStyle(long ID)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3f1, DISPATCH_METHOD, VT_EMPTY, NULL, parms, ID);
	}
	long GetStyleCount()
	{
		long result;
		InvokeHelper(0x3f2, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	LPDISPATCH GetPOIListInRadius(LPDISPATCH MapPos, long GroupID, long Distance)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH VTS_I4 VTS_I4 ;
		InvokeHelper(0x3f3, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, MapPos, GroupID, Distance);
		return result;
	}
	void SetTopItem(LPDISPATCH POIItem)
	{
		static BYTE parms[] = VTS_DISPATCH ;
		InvokeHelper(0x3f4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, POIItem);
	}
