...
class CXShapeMan : public COleDispatchDriver
{
public:
	CXShapeMan(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CXShapeMan(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CXShapeMan(const CXShapeMan& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH NewShape(LPCTSTR Name)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
	...
	LPDISPATCH GetShape(LPCTSTR Name)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
	...
	BOOL RemoveShape(LPCTSTR Name)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Name);
		return result;
	}
