...
class CTextMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CTextMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CTextMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CTextMemDC*() {return this;}

	

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CTextMemDC
...
CFont CTextProgressCtrl::m_TextFont;
...
CTextProgressCtrl::CTextProgressCtrl()
{
	...
	if(!m_TextFont.GetSafeHandle())
		m_TextFont.CreateFont(15,0,0,0,0,0,0,0,HANGUL_CHARSET, 0,0,0,0, "Tahoma");
...
LRESULT CTextProgressCtrl::OnSetText(UINT, LPARAM lParam)
{
...
LRESULT CTextProgressCtrl::OnGetText(UINT cchTextMax, LPARAM lParam)
{
