...
BOOL COptionDlgSmartQuick::Save(long nCompany, BOOL bAll)
{
	...
	cmd.AddParameter(::GetLongFromEdit(&m_edtWithdrawAbleMileage));
	cmd.AddParameter(::GetLongFromEdit(&m_edtWithdrawAbleMileageMax));
	cmd.AddParameter(::GetLongFromEdit(&m_cmbMonthlyWithdrawAbleMileage));
	cmd.AddParameter(::GetLongFromEdit(&m_cmbDailyWithdrawAbleMileageCount));
	cmd.AddParameter(::GetLongFromEdit(&m_edtMileageToCashPer));
	cmd.AddParameter(m_chkUseEventBoard.GetCheck());
	cmd.AddParameter(::GetStringFromEdit(&m_edtChargeEtc));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc0));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc1));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc2));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc3));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc4));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc6));
	cmd.AddParameter(::GetStringFromEdit(&m_edtPayTypeEtc7));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeWeightEtc0));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeWeightEtc2));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeWeightEtc3));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeWeightEtc4));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeWeightEtc5));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeEtc0));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeEtc2));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeEtc3));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeEtc4));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCarTypeEtc5));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCustomerEtc1));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCustomerEtc2));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCustomerEtc3));
	cmd.AddParameter(::GetStringFromEdit(&m_edtCustomerEtc4));
	cmd.AddParameter(::GetStringFromEdit(&m_edtItemTypeEtc1));
	cmd.AddParameter(::GetStringFromEdit(&m_edtItemTypeEtc2));
	cmd.AddParameter(::GetStringFromEdit(&m_edtItemTypeEtc3));
	cmd.AddParameter(::GetStringFromEdit(&m_edtItemTypeEtc4));
	cmd.AddParameter(::GetStringFromEdit(&m_edtItemTypeEtc5));
	...
	cmd.AddParameter(::GetStringFromEdit(&m_edtInquiryChargeMent));
	cmd.AddParameter(m_chkUseCustomerChargeChange.GetCheck());
	cmd.AddParameter(::GetLongFromEdit(&m_edtChargeChangeMin));
	cmd.AddParameter(::GetLongFromEdit(&m_edtChargeChangeMax));
	cmd.AddParameter(::GetStringFromEdit(&m_edtChargeChangeMent));
...
void COptionDlgSmartQuick::RefreshData(CMkRecordset *pRs)
{
	...
	m_edtWithdrawAbleMileage.SetWindowText(::GetMyNumberFormat(nWithdrawAbleMileage));
	m_edtWithdrawAbleMileageMax.SetWindowText(::GetMyNumberFormat(nWithdrawAbleMileageMax));
	m_cmbMonthlyWithdrawAbleMileage.SetWindowText(::GetMyNumberFormat(nMonthlyWithdrawAbleMileage));
	m_cmbDailyWithdrawAbleMileageCount.SetWindowText(::GetMyNumberFormat(nDailyWithdrawAbleMileageCount));
	m_edtMileageToCashPer.SetWindowText(::GetMyNumberFormat(nMileageToCashPer));
	...
	m_edtChargeChangeMin.SetWindowText(::GetMyNumberFormat(nChargeChangeMin));
	m_edtChargeChangeMax.SetWindowText(::GetMyNumberFormat(nChargeChangeMax));
