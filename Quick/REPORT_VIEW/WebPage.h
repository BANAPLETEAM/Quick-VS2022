...
public:
	...
	//bool CallJScript(const CString strFunc, IHTMLDocument2 *pDoc );
	bool CallJScript(const CString strFunc, LPDISPATCH pDocDisp);
	bool CallJScript(const CString strFunc, IHTMLDocument2 *pDoc,  IWebBrowser2 *pBrowserApp);
	bool CallJScript(const CString strFunc, IHTMLDocument2 *pDoc,  IWebBrowser2 *pBrowserApp,  CWnd *pDlg);
