...
void CTransferSmsBetweenShareBalanceDlg::DrawToSmsCharge(CDC *pDC)
{
	...
	if(m_nMinusShareBalanceCompany > 0)
	{
		...
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 0, 255), LF->GetMyNumberFormat(m_nMinusShareBalance) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
	...
	if(m_nPlusSmsCompany > 0)
	{
		...
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 255, 0), LF->GetMyNumberFormat(m_nPlusSms) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
	...
	if(m_nMinusShareBalanceCompany > 0)
	{
		...
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 0, 255), LF->GetMyNumberFormat(m_nMinusShareBalance - nCharge) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
	...
	if(m_nPlusSmsCompany > 0)
	{
		...
		nLeft = DrawStcText(pDC, RGB(0, 0, 0), "지사의 SMS잔액 ", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 255, 0), LF->GetMyNumberFormat(m_nPlusSms + nCharge) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
...
void CTransferSmsBetweenShareBalanceDlg::DrawToShareBalanceCharge(CDC *pDC)
{
	...
	if(m_nMinusSmsCompany > 0)
	{
		...
		nLeft = DrawStcText(pDC, RGB(0, 0, 0), "지사의 SMS잔액 ", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 255, 0), LF->GetMyNumberFormat(m_nMinusSms) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
		DrawStcText(pDC, RGB(0, 0, 0), "[SMS잔액 (-)]로 드래그하세요", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	...
	if(m_nPlusShareBalanceCompany > 0)
	{
		...
		nLeft = DrawStcText(pDC, RGB(0, 0, 0), "지사의 공유정산잔액 ", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 0, 255), LF->GetMyNumberFormat(m_nPlusShareBalance) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
		DrawStcText(pDC, RGB(0, 0, 0), "[공유정산금 (+)]로 드래그하세요", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	...
	if(m_nMinusSmsCompany > 0) 
	{
		...
		nLeft = DrawStcText(pDC, RGB(0, 0, 0), "지사의 SMS잔액 ", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 255, 0), LF->GetMyNumberFormat(m_nMinusSms - nCharge) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
		DrawStcText(pDC, RGB(0, 0, 0), "---------------------------------------------", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	...
	if(m_nPlusShareBalanceCompany > 0)
	{
		...
		nLeft = DrawStcText(pDC, RGB(0, 0, 0), "지사의 공동정산잔액 ", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
		rcTemp.left += nLeft + 2; 
		nLeft = DrawStcText(pDC, RGB(0, 0, 255), LF->GetMyNumberFormat(m_nPlusShareBalance + nCharge) +"원", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
	}
	else
		DrawStcText(pDC, RGB(0, 0, 0), "---------------------------------------------", rcTemp, m_FontManager.GetFont("맑은 고딕", 17, FW_BOLD));
};
