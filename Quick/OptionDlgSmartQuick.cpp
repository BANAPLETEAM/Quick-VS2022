...
BOOL COptionDlgSmartQuick::Save(long nCompany, BOOL bAll)
{
	...
	CMkCommand cmd(m_pMkDb, "update_option_smart_quick_6");
...
{
	BOOL bUseAutoWithdraw, bUseEventBoard, bUsePayCash, bUseRunType1, bUseInquiryCharge;
	...
	CString strItemTypeEtc1, strItemTypeEtc2, strItemTypeEtc3, strItemTypeEtc4, strItemTypeEtc5;
