...
void CSmsRegisterLogDlg::RefreshLogList()
{
	...
	for(int i=0; i<rs.GetRecordCount(); i++)
	{
		...
		m_lstLogList.SetItemText(i, 3, ::GetDashPhoneNumber(strTel));
		m_lstLogList.SetItemText(i, 4, strEtc);
		m_lstLogList.SetItemText(i, 5, ::GetSMSTelUse(nUse));
		m_lstLogList.SetItemText(i, 6, ::GetSMSFileStateType(nState));
		m_lstLogList.SetItemText(i, 7, ::GetSMSTelCorp(nCorpType));
		m_lstLogList.SetItemText(i, 8, ::GetSMSFileStateType(nTelecomState, nTelType));
		m_lstLogList.SetItemText(i, 9, ::GetSMSFileStateType(nIdentityCardState, nTelType));
