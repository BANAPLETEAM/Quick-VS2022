...
void CSortListCtrl::OnColumnClick( NMHDR* pNMHDR, LRESULT* pResult )
{
	...
	//SortOnlyImage( iColumn, iColumn == m_iSortColumn ? !m_bSortAscending : TRUE );
...
void CSortListCtrl::SortOnlyImage()
{
	// show the appropriate arrow in the header control.
	m_ctlHeader.SetSortArrow( m_iSortColumn, m_bSortAscending );
}

void CSortListCtrl::SortOnlyImage(int iColumn, BOOL bAscending)
{
	m_iSortColumn = iColumn;
	m_bSortAscending = bAscending;
