...
public:
	...
	virtual BOOL LoadStdImage(UINT id, LPCTSTR pType, HMODULE hInst = NULL);
	virtual BOOL LoadHotImage(UINT id, LPCTSTR pType, HMODULE hInst = NULL);
...
protected:
	...
	CGdiPlusBitmapResource* m_pHotImage;
